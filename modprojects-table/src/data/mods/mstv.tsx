...
export default [
    ...
    },
    {
        ...
        requirements: [dependencies.MStV],
        authors: [authors.pnku],
        versions: [
            {
                display: "1.20.1",
    ...
    },
    {
        ...
        image: "https://raw.githubusercontent.com/pnk2u/resources/main/ModProjects/Nemos-More-Ladder-Variants/pres/logo/logo.png",
        requirements: [dependencies.MStV],
    ...
    },
    {
        ...
        requirements: [dependencies.MStV],
        recommended: [dependencies.quad, dependencies.mTorchV],
        authors: [authors.pnku],
        versions: [
            {
                display: "1.20.1",
