...
function colorABSelector(paletteIndex) {
    ...
    let a_rgb = isBarAbove ? a_r + a_g + a_b + 1 : 100; // Adding 1 to avoid division by zero
    ...
    if (isBarAbove) {oklabColorARgbRectR.style.marginLeft = "8px";
                    oklabColorARgbRectG.style.marginLeft = 7 + (a_r / a_rgb) * a_w + "px";}
    ...
    let b_rgb = isBarAbove ? b_r + b_g + b_b + 1 : 100; // Adding 1 to avoid division by zero
    ...
    if (isBarAbove) {oklabColorBRgbRectR.style.marginLeft = "8px";
                    oklabColorBRgbRectG.style.marginLeft = 7 + (a_r / a_rgb) * a_w + "px"}
    ...
    if (isBarAbove) {oklabColorBRgbRectB.style.marginLeft = 7 + ((b_r + b_g) / b_rgb) * b_w + "px";
